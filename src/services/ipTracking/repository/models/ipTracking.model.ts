...
export interface IIPTrackingModel extends Model<IIPTracking> {
  // Add any static methods here if needed
}

const ipTrackingSchema = new Schema<IIPTracking, IIPTrackingModel>(
  {
    ipAddress: {
      type: String,
      required: true,
...
const IPTracking = mongoose.model<IIPTracking, IIPTrackingModel>("IPTracking", ipTrackingSchema);
